...
router.get('/specialTeamsAllowed/:teamName', async (req, res) => {
    ...
    try {
        ...
        const gameIds = await axios.get(`localhost:/api/games/team/gameIds/${req.params.teamName}`)
            .then((response) => {
...
router.get('/team/:teamName', async (req, res) => {
    ...
    try {
        ...
        const games = await axios.get(`localhost:/api/games/team/${req.params.teamName}`)
            .then((response) => {
                if (response.status === 200) {
                    return response.data
                } else {
...
router.get('/', async (req, res) => {
    ...
    try {
        ...
        //Get Games IDs For the latest week
        const games = await axios.get(`localhost:/api/games`)
            .then((response) => {
                if (response.status === 200) {
                    return response.data
